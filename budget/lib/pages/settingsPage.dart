    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          // Сводка по всей семье имеет смысл только у владельца: у остальных в
          // базе лежат лишь их собственные операции.
          if (FamilyServer.isOwner)
            SettingsContainerOpenPage(
              openPage: OwnerDashboardPage(),
          ...
          SettingsContainerOpenPage(
            openPage: FamilyServerPage(),
            title: "family-server".tr(),
            icon: appStateSettings["outlinedIcons"]
                ? Icons.groups_outlined
                : Icons.groups_rounded,
            description: FamilyServer.isSignedIn
                ? FamilyServer.currentUserName +
                    " · " +
                    (FamilyServer.isOwner
                        ? "role-owner".tr()
                        : "role-member".tr())
                : null,
            isOutlined: true,
