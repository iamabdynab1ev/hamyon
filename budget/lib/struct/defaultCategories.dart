...
List<TransactionCategory> defaultCategories() {
  return [
    ...
    TransactionCategory(
      categoryPk: "12",
      name: "default-category-celebrations".tr(),
      colour: toHexString(Colors.pinkAccent),
      iconName: "celebration.png",
      dateCreated: DateTime.now(),
      dateTimeModified: null,
      order: 11,
      income: false,
    ...
    TransactionCategory(
      categoryPk: "13",
      name: "default-category-charity".tr(),
    ...
    TransactionCategory(
      categoryPk: "14",
      name: "default-category-communication".tr(),
    ...
    TransactionCategory(
      categoryPk: "15",
      name: "default-category-health".tr(),
      colour: toHexString(Colors.redAccent),
    ...
    TransactionCategory(
      categoryPk: "16",
      name: "default-category-education".tr(),
